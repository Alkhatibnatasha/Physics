...
traindata =PhysicsDataset(x, y,'train')
...
validdata = PhysicsDataset(x, y, 'valid')
...
#Took testing data same as training data (you can change it)
testdata = PhysicsDataset(x, y, 'test')
